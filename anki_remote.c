...
#include "ble_hid.h" // Make sure this path is correct for your firmware
...
static void anki_remote_set_scene(AnkiRemoteApp* app, AppScene new_scene) {
    ...
    if(new_scene == SceneController) {
        // bt_disconnect(app->bt); // No need to disconnect here, connection will be established
        // furi_delay_ms(200);
        ...
        // Hier aktivieren wir die Logik für den benutzerdefinierten Bluetooth-Namen
